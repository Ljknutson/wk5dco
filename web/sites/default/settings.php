 ...
 * @endcode
 */
$settings['hash_salt'] = 'cL-MrTkohxMYwgNyKyBrkDYnjPM9u6C6M3ZB-nQ9dimpcWwlLyxrzVmXnO_Ce_v3xyJCvDVT1A';
...
web/sites/default/default.settings.php web/sites/default/settings.php
 *
 ...
 */
 ...
 if (file_exists($app_root . '/' . $site_path . '/settings.landol.php')) {
...
$settings['config_sync_directory'] = 'sites/default/files/config_QhXAuIURo-yLvzTSqKmnP4TUiAuQvsORctzXxVpO-xT2dGn4dBiNXW7mhwYwawzM6HxNog6RZQ/sync';
